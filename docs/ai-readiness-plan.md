...
Next action:    Task 1.2 — emit one .md twin per component; skip internal
                components (BaseSheet), handle EmptyState's missing token file
Blocked on:     nothing
```
