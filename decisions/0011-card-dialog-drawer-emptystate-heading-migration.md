...
- `components/composition/Dialog/AlertDialog.tsx` — deliberately out of scope, the reason `.dialog__title`'s base rule stays intact
...
- `decisions/0010-heading-weight-prop.md` — replaced this migration's font-weight compound-selector pattern for `Card`/`Drawer` with a prop
