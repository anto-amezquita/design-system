...
- **29 components** across primitives, composition, and pattern tiers — 28 of them with full Storybook coverage including a required dark-mode story (BaseSheet is an internal overlay primitive with no stories of its own); 201 stories, zero visual regressions across every Chromatic build
